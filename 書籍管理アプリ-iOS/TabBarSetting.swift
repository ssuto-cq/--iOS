...
class TabBarSetting: UITabBarController, UITabBarControllerDelegate {
        ...
        //書籍一覧画面
        let booksViewScene = UINavigationController(rootViewController: BooksViewController())
        ...
        //設定前画面
        let beforeSettingScene = UINavigationController(rootViewController: BeforeSettingViewController())
